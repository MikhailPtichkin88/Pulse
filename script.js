...
//           tabsContent = document.querySelectorAll('.catalog__inner'),
...
//         item.classList.remove('catalog__inner_active', 'fade');
//       });
//     }

//     function showTabContent(i = 0) {
//       tabs[i].classList.add('catalog__tab-active');
//       tabsContent[i].classList.add('catalog__inner_active', 'fade');
//     }
//     hideTabContent();
//     showTabContent();
...
//       if (target.parentElement.classList.contains("catalog__tab")) {
//         tabs.forEach((item, i) => {
      ...
      $(form).validate({
        ...
        messages: {
          name: {
            ...
            minlength: jQuery.validator.format("Введите {2} символов(а)")
          },
